...
<h3 align="center">
  <a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&width=435&lines=Astrodynamics+Researcher;Spacecraft+System+Engineer;Extra+Shots+Espresso&center=true&width=500&height=50" alt="Typing SVG" /></a>
</h3>
...
class WhoAmI {
  ...
  public:
    WhoAmI(std::string name, std::string uni, std::string current, std::project) {
      this->name = Cooper;
      this->uni = Imperial_College_London
      this->current = Taiwan Space Agency (TASA)
      this->project = Astrodynamics && System_Eng
    }
```
